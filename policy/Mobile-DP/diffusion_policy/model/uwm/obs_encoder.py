...
from diffusion_policy.model.common.language import CLIPTextEncoder
from diffusion_policy.model.common.transforms import VideoTransform, VAEDownsample
from diffusion_policy.model.common.vision import ResNetImageEncoder, ViTImageEncoder
...
class UWMObservationEncoder(nn.Module):
    ...
    def encode_curr_and_next_obs(self, curr_obs_dict: dict, next_obs_dict: dict):
        ...
        # changed by roy, avoid curr_obs_dict and next_obs_dict have different time length
        # curr_imgs = self.apply_transform(curr_obs_dict)
        # next_imgs = self.apply_transform(next_obs_dict)
    ...
    def feat_dim(self):
        ...
        return (
            ...
            + int(self.use_low_dim) * low_dim_size
