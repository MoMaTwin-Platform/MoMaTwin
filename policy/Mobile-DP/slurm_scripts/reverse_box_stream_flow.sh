#!/bin/bash
#SBATCH --job-name=reverse_box_stream_flow
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=124
#SBATCH --gres=gpu:8
#SBATCH --mem=1600G
#SBATCH -o /x2robot/caichuang/extra_codes/dp_roy/diffusion_policy/slurm_outputs/%x-%j.log
...
export SCRIPT_ARGS="--config-name=reverse_box_stream_flow"
