#!/bin/bash
#SBATCH --job-name=entangle_line_threefork_master_obs_follow_cur
#SBATCH --nodes=5
...
#SBATCH -o /x2robot/xinyuanfang/projects/diffusion_policy/workspace/entangle_line_threefork_master_obs_follow_cur/%x-%j.log
...
export SCRIPT_ARGS="--config-name=entangle_line_threefork_master_obs_follow_cur"
