#!/bin/bash
#SBATCH --job-name=entangle_line_threefork_joint
#SBATCH --nodes=1
...
#SBATCH -o /x2robot/xinyuanfang/projects/diffusion_policy/workspace/entangle_line_threefork_joint/%x-%j.log
...
export SCRIPT_ARGS="--config-name=entangle_line_threefork_joint"
