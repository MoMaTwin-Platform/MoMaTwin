#!/bin/bash
#SBATCH --job-name=test_light_aug_cup_p20_10015
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=124
#SBATCH --gres=gpu:8
#SBATCH --mem=1600G
#SBATCH -o /x2robot_v2/ganruyi/workspace/diffusion_policy/logs/%x-%j.log
...
export SCRIPT_ARGS="--config-name=pick_cup_car"
# export SCRIPT_ARGS="--config-name=pick_cup_car_pi0"
